...
document.addEventListener("DOMContentLoaded", function() {
  ...
  // Get weather information for Kathmandu, Nepal
  getWeather();
});
...
function getWeather() {
  const apiKey = "907961ecf95a2fcfe579e9f7edaf9652"; // Replace this with your actual API key
  ...
  fetch(weatherUrl)
      ...
      .catch(error => {
          ...
          weatherElement.textContent = "Weather Loading...";
          temperatureElement.textContent = "Tempr. Loading...";
